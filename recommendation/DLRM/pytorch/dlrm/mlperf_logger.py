...
def config_logger():
    ...
    log_file = os.environ.get('MLPERF_LOG_FILE', 'dlrm.log')
...
def mlperf_submission_log(benchmark):
    ...
    submission_system = os.environ.get('MLPERF_SUBMISSION_SYSTEM', 'AMD system')
    cache_clear = int(os.environ.get('MLPERF_CACHE_CLEAR', 0)) == 1
    ...
    log_event(
        ...
        value=f'{num_nodes}x{submission_system}')
