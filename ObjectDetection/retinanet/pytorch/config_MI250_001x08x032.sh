...
export EXTRA_PARAMS=${EXTRA_PARAMS:-'--jit --amp -frozen-bn-opt --frozen-bn-fp16 --apex-adam --apex-focal-loss --fp16-allreduce --reg-head-pad --cls-head-pad --skip-metric-loss --async-coco'}
