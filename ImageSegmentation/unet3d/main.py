...
def main():
    ...
    mllog.config(filename=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                       f'unet3d_{flags.nproc_per_node}gpu_{flags.optimizer}_{flags.platform}.log'), default_namespace='UNet-3D')
