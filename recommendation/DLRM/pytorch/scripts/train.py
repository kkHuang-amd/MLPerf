...
flags.DEFINE_float("mlp_momentum", 0, "MLP momentum")
...
flags.DEFINE_boolean("use_alltoall_base", False, "Use ProcessGroupNCCL::alltoall_base internally")
flags.DEFINE_boolean("use_emb_sgd_ext", False, "Use SGD HIP extension. If False, use PyTorch's SGD.")
flags.DEFINE_boolean("use_apex_mlp", True, "Use APEX MLP instead of PyTorch MLP.")
flags.DEFINE_boolean("compress_embedding", False, "Compress embedding data to reduce communication")
flags.DEFINE_boolean("use_fused_emb_sgd", False, "Fuse SGD with embedding")
flags.DEFINE_boolean("use_wmma_interaction", False, "Use WMMA for the dot operation.")
...
flags.DEFINE_boolean("debug", False, "Enable detailed printing")
...
flags.DEFINE_boolean("preset_device_mapping", True, "Use preset device mapping from MLPerf submission")
