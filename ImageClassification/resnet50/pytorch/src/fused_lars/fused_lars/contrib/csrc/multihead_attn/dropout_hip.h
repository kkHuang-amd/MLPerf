...
void apex_fused_dropout_cuda(scalar_t const *inputs, scalar_t *outputs,
 ...
 hipLaunchKernelGGL(( apex_fused_dropout_kernel<scalar_t, accscalar_t, IndexType>)
...
void apex_dropout_add_cuda(scalar_t const *inputs, scalar_t const *add_inputs,
 ...
 hipLaunchKernelGGL(( apex_dropout_add_kernel<scalar_t, accscalar_t, IndexType>)
      , dim3(grid), dim3(dim_block), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
...
void apex_add_cuda(scalar_t const *inputs, scalar_t const *add_inputs,
 ...
 hipLaunchKernelGGL(( apex_add_kernel<scalar_t, accscalar_t, IndexType>)
      , dim3(grid), dim3(dim_block), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
...
void apex_masked_scale_cuda(scalar_t const *inputs, scalar_t *outputs,
 ...
 hipLaunchKernelGGL(( apex_masked_scale_kernel<scalar_t, accscalar_t, IndexType>)
      , dim3(grid), dim3(dim_block), 0, at::hip::getCurrentHIPStreamMasqueradingAsCUDA(), 
