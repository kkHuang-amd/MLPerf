    ...
    def __init__(
        ...
        if in_channels != out_channels:
            ...
            self.downsample = nn.Sequential(
                ...
                torch.jit.script(norm_func(out_channels)),
            )
        ...
        self.bn1 = torch.jit.script(norm_func(bottleneck_channels))
        ...
        self.bn2 = torch.jit.script(norm_func(bottleneck_channels))
        self.conv3 = conv(
            bottleneck_channels, out_channels, kernel_size=1, bias=False
        )
        self.bn3 = torch.jit.script(norm_func(out_channels))
...
class BaseStem(torch.nn.Module):
    def __init__(self, cfg, norm_func):
        ...
        self.bn1 = torch.jit.script(norm_func(out_channels))
