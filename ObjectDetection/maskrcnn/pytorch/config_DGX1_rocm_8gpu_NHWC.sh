...
export EXTRA_CONFIG='SOLVER.BASE_LR 0.08 SOLVER.MAX_ITER 600000 SOLVER.WARMUP_FACTOR 0.000128 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (18000,24000) SOLVER.IMS_PER_BATCH 64 TEST.IMS_PER_BATCH 8 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 8000 NHWC True DATALOADER.HYBRID True PRECOMPUTE_RPN_CONSTANT_TENSORS True'
...
export DGXSYSTEM='DGX1_rocm_8gpu_NHWC'
