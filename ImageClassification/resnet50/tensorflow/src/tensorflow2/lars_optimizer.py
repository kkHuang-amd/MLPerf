...
if tf.test.is_built_with_cuda():
    from tf2_common.training.cuda_optimizer_v2modified import OptimizerV2Modified
else:
    from tf2_common.training.optimizer_v2modified import OptimizerV2Modified

from tensorflow.python.framework import ops
from tf2_common.utils.misc import model_helpers
if model_helpers.version_compare_ge(tf.__version__, "2.6.0"):
    import keras as ks
    if model_helpers.version_compare_ge(ks.__version__, "2.9.0"):
...
class LARSOptimizer(OptimizerV2Modified):
