...
at::Tensor syncfree_generate_mask_targets(at::Tensor clamped_idxs, const std::vector<std::vector<at::Tensor>> polygons, const at::Tensor anchors, const int mask_size)                                                                                                                                                      {                                                                                                                                                               at::Tensor results = syncfree_generate_mask_targets_cuda(clamped_idxs, polygons, anchors, mask_size);
  return results;                                                                                                                                             }           
