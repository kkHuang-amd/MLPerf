...
if os.getenv("MASKRCNN_ROCM_BUILD", "0") == "0":
    #need cudnn deterministic to be set on nvidia for NHWC
...
def train(cfg, local_rank, distributed, random_number_generator=None, seed=None):
    ...
    if True: #cfg.DATALOADER.ALWAYS_PAD_TO_MAX or cfg.USE_CUDA_GRAPH:
